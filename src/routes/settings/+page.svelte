...
<div class="mx-auto max-w-2xl p-6 pt-12">
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between rounded-lg bg-white p-4 shadow-md dark:bg-neutral-800">
            <div>
            ...
            <label class="relative inline-flex cursor-pointer items-center">
                <input
                    ...
                    on:change={() => settings.toggleTimerSound()}
                />
                <div class="peer h-6 w-11 rounded-full bg-neutral-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:bg-white after:transition-all after:content-[''] peer-checked:bg-primary-600 peer-checked:after:translate-x-full peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-primary-500 dark:bg-neutral-700"></div>
            </label>
        </div>
        ...
        <div class="rounded-lg bg-white p-4 shadow-md dark:bg-neutral-800">
            <div class="mb-4">
                ...
                <p class="text-sm text-neutral-600 dark:text-neutral-400">Choose your preferred color theme</p>
            </div>
